...
public class LoginServiceImpl implements ILoginService {
    ...
    private String getFullName(Utilisateur user) {
        ...
        if (user instanceof com.groupe.gestionDesStages.models.Etudiant) {
            ...
            System.out.println("Etudiant - Nom: " + etudiant.getNom() + ", Prenom: " + etudiant.getPrenom());
            String fullName = etudiant.getPrenom() + " " + etudiant.getNom();
            System.out.println("Full name généré: " + fullName);
            return fullName;
        ...
        System.out.println("Aucun type reconnu, retour email: " + user.getEmail());
